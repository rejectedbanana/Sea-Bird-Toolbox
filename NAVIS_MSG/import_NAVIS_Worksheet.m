...
%% LOAD THE DATA
% Search the data folder for all message files, then parse all the files
% and build the data structure "s". Each field contains all the data from a
% .msg file with substructures containing the configuration (header), park, discrete,
% profiling and engineering (footer) data. Field numbers match profile
% numbers. If there is no message file found for a profile, that field will
% be empty.
